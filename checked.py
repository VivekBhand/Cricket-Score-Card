...
def TEAM():
    ...
    # command=add_result
    Button(window, text="Submit", font=('Times New Roman', 15)).place(x=550, y=550)
...
def UMPIRES():
    ...
    # , command=add_result
    Button(show_res_window, text="Submit", font=('Times New Roman', 15)).place(x=550, y=550)
...
Button(lbl, text="UMPIRE", font=('Times New Roman', 20),command=UMPIRES).place(relx=0.45,rely=0.65)
